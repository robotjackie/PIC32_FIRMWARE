...
void SYS_PORTS_Initialize(void)
{
    ...
    PLIB_PORTS_Toggle( PORTS_ID_0, PORT_CHANNEL_C,  SYS_PORT_C_LAT);
    ...
    PLIB_PORTS_Toggle( PORTS_ID_0, PORT_CHANNEL_H,  SYS_PORT_H_LAT);
    ...
    PLIB_PORTS_Toggle( PORTS_ID_0, PORT_CHANNEL_J,  SYS_PORT_J_LAT);
    ...
    PLIB_PORTS_Toggle( PORTS_ID_0, PORT_CHANNEL_K,  SYS_PORT_K_LAT);
